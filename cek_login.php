...
$cekmhs = mysqli_query($konek, "SELECT * FROM tb_user INNER JOIN mahasiswa ON mahasiswa.id_user = tb_user.id_user WHERE username='$username' AND password='$password'");

$result = mysqli_num_rows($cek);
$resultmhs = mysqli_num_rows($cekmhs);
$data = mysqli_fetch_array($cek);
$datamhs = mysqli_fetch_array($cekmhs);
