...
<?php
        ...
        $insertSql = "INSERT INTO gaji (rekening_no, rekening_bank, kehadiran, gaji_pokok, gaji_bonus, gaji_lembur, bpjs_kesehatan, bpjs_tenaker, pinjaman, biaya_transfer, id_pegawai, tanggal, status) value (:rekening_no, :rekening_bank, :kehadiran, :gaji_pokok, :gaji_bonus, :gaji_lembur, :bpjs_kesehatan, :bpjs_tenaker, :pinjaman, :biaya_transfer, :id_pegawai, :tanggal, :status)";
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST">
                ...
                <input type="hidden" name="status" value="pegawai" hidden>
