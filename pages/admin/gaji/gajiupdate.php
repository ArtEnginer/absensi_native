...
// get data from database pegawai
...
if(isset($_POST['update'])){
    ...
    $database = new Database();
    $db = $database->getConnection();
    $query = "UPDATE gaji SET id_pegawai = :id_pegawai, rekening_no = :rekening_no, rekening_bank = :rekening_bank, kehadiran = :kehadiran, gaji_pokok = :gaji_pokok, gaji_bonus = :gaji_bonus, gaji_lembur = :gaji_lembur, bpjs_kesehatan = :bpjs_kesehatan, bpjs_tenaker = :bpjs_tenaker, pinjaman = :pinjaman, biaya_transfer = :biaya_transfer, tanggal = :tanggal WHERE id = :id";
    $stmt = $db->prepare($query);
    $stmt->bindParam(':id_pegawai', $idpegawai);
        ...
        <div class="card-body">
            <form method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $pegawai['nm_pegawai'] ?>" readonly>
                    <input type="text" class="form-control" name="id_pegawai" hidden readonly value="<?= $pegawai['id_pegawai'] ?>">
                </div>
                <div class="form-group">
