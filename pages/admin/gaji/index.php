...
$gaji = [];
// $result = $mysqli->query("SELECT * FROM gaji WHERE status = 'pegawai'");
// var_dump($result->fetch_object());
// die();
if ($result = $mysqli->query("SELECT * FROM gaji INNER JOIN pegawai ON gaji.id_pegawai = pegawai.id_pegawai" . " WHERE gaji.status = 'pegawai'")) {
