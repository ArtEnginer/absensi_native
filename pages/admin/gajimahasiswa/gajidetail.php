...
$gaji = new stdClass;
if ($result = $mysqli->query("SELECT * FROM gaji INNER JOIN mahasiswa ON gaji.id_mahasiswa = mahasiswa.id_mahasiswa WHERE id='$_GET[id]'")) {
...
<div class="content">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"> Detail Gaji <?= $gaji->nama_mahasiswa ?></h3>
            <a href="#!" class="btn btn-success btn-sm float-right mx-2" onclick="printDiv('slipgaji')">
                <i class="fa fa-print"></i> Print</a>
            <a href="?page=gajimahasiswa" class="btn btn-danger btn-sm float-right mx-2">
        ...
        <div class="card-body" id="slipgaji">
            ...
            <div class="row mt-4">
                <div class="col text-end">
                    ...
                    <p class="mt-6"><strong>(<?= $gaji->nama_mahasiswa ?>)</strong></p>
                </div>
            </div>
        </div>
    </div>
