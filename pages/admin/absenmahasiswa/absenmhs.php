...
$query = $mysqli->query("SELECT * FROM tb_absenmhs WHERE id_mahasiswa='$_SESSION[id_mahasiswa]' AND tanggal='$tanggal'");
...
if (isset($_POST['masuk'])) {
    if ($data) {
        ...
        $res =  mysqli_query($konek, "INSERT INTO tb_absenmhs SET id_mahasiswa='$id', tanggal='$tanggal', jam_masuk= '$jamSekarang'");
...
<section class="content">
    <div class="card">
        <div class="card-header d-flex justify-content-md-between">
            <h3 class="col-sm-10">Halo, <?php echo $_SESSION['nama_mahasiswa'] ?>!</h3>
                ...
                <table class="table table-striped datatables-init" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <?php while ($riwayat = $query2->fetch_object()) : ?>
                            <?php $mahasiswa = $mysqli->query("SELECT * FROM mahasiswa WHERE id_mahasiswa='$riwayat->id_mahasiswa'")->fetch_object() ?>
                            <tr>
                                <td><?= $no ?></td>
