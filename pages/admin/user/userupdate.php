...
if (isset($_GET['id_user'])) {
        ...
        $query = "SELECT * FROM tb_user,pegawai WHERE tb_user.id_user = $id AND tb_user.id_user = pegawai.id_user";
...
?>
        ...
        <?php } else {
                                        ...
                                        // update data from post data in tb_user and pegawai

                                        $insertSql = "UPDATE tb_user, pegawai SET username = ?, password = ?, peran = ?, nm_pegawai=? WHERE tb_user.id_user = pegawai.id_user AND tb_user.id_user = $id";
                        ...
                        <div class="row mb2">
                                ...
                                <div class="col-sm-6">
                                        <ol class="breadcrumb float-sm-right">
                                                ...
                                                <li class="breadcrumb-item"><a href="?page=pangkatread"></a></li>
                        ...
                        <div class="card-body">
                                <form method="POST">
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $row['nm_pegawai'] ?>" name="nama" required>
                                        </div>
                                        <div class="form-group">
